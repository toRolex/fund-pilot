import type { Fund, FundDetail, HoldingResponse, NavPoint, QdiiPredictResponse, SignalResponse, StrategyLog, StrategyPlugin, StrategyState, SystemStatus } from "@/types";
